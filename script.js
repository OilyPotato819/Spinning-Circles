...
class orbiter {
   ...
   draw() {
      this.x = this.centralDot.x + (this.distance * Math.cos(this.angle * Math.PI / this.degreesNum));
      this.y = this.centralDot.y + (this.distance * Math.sin(this.angle * Math.PI / this.degreesNum));
